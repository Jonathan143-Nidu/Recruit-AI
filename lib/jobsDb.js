...
export async function isAdmin() {
    ...
    const req = new NextRequest('https://recruit.innovcentric.com/', { headers: reqHeaders });
    const token = await getToken({ req, secret: process.env.NEXTAUTH_SECRET || "fallback_secret_for_dev_mode_only" });
